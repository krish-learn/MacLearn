...
### Accuracy for Random Forest model is 99% compared to Decision Tree model accuracy of 68% and hence we go with Random Forest model to test the sample data given.
